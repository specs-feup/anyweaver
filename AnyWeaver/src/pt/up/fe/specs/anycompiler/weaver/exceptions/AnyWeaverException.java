package pt.up.fe.specs.anycompiler.weaver.exceptions;
 ...
 */
public class AnyWeaverException extends BaseException {
     ...
     */
    public AnyWeaverException(String event){
        this(event,null);
    }
    /**
     ...
     */
    public AnyWeaverException(String event, Throwable cause){
        super(cause);
        this.event = event;
    }
    /**
